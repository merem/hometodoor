...
class Controllermyproductsmyproducts extends Controller {
	...
	protected function getList() {
		...
		$product_total = $this->model_myproducts_myproducts->getTotalProducts($data);
		...
		foreach ($results as $result) {
			...
			$product_specials = $this->model_myproducts_myproducts->getProductSpecials($result['product_id']);
	...
	//	$this->template = 'myproducts/product_list.tpl';
		$this->children = array(
				'common/header',
				'common/footer'
		);
