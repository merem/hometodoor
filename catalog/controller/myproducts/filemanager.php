<?php
class Controllermyproductsfilemanager extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/myproducts/filemanager.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/myproducts/filemanager.tpl';
		} else {
			$this->template = 'default/template/custompage/filemanager.tpl';
		}
