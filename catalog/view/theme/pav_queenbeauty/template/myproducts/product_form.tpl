...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
  ...
  <div class="box container">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button  btn btn-outline"> <?php echo $button_save; ?> </a>&emsp;<a href="<?php echo $cancel; ?>" class="button  btn btn-outline"> <?php echo $button_cancel; ?> </a></div>
    </div>
    <div class="content">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><div id="product-category" class="scrollbox">
                  ...
                  <div id="product-category<?php echo $product_category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_category['name']; ?><img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-filter" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-filter<?php echo $product_filter['filter_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_filter['name']; ?><img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-download" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-download<?php echo $product_download['download_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_download['name']; ?><img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" />
            ...
            <tr>
              ...
              <td><div id="product-related" class="scrollbox">
                  ...
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-related<?php echo $product_related['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_related['name']; ?><img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" />
     ...
     <?php  ?>     
        ...
        <div id="tab-option">
          <div id="vtab-option" class="vtabs">
            ...
            <a href="#tab-option-<?php echo $option_row; ?>" id="option-<?php echo $option_row; ?>"><?php echo $product_option['name']; ?>&nbsp;<img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" onclick="$('#option-<?php echo $option_row; ?>').remove(); $('#tab-option-<?php echo $option_row; ?>').remove(); $('#vtabs a:first').trigger('click'); return false;" /></a>
            <?php $option_row++; ?>
            <?php } ?>
            <span id="option-add">
            <input name="option" value="" style="width: 130px;" />
            &nbsp;<img src="catalog/view/theme/pav_queenbeauty/image/add.png" alt="<?php echo $button_add_option; ?>" title="<?php echo $button_add_option; ?>" /></span></div>
          <?php $option_row = 0; ?>
...
$('input[name=\'category\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#product-category').append('<div id="product-category' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" /><input type="hidden" name="product_category[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'filter\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=myproducts/filter/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-filter').append('<div id="product-filter' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" /><input type="hidden" name="product_filter[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'download\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=myproducts/download/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-download').append('<div id="product-download' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" /><input type="hidden" name="product_download[]" value="' + ui.item.value + '" /></div>');
...
$('input[name=\'related\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=myproducts/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
	...
	select: function(event, ui) {
		...
		$('#product-related').append('<div id="product-related' + ui.item.value + '">' + ui.item.label + '<img src="catalog/view/theme/pav_queenbeauty/image/delete.png" alt="" /><input type="hidden" name="product_related[]" value="' + ui.item.value + '" /></div>');
