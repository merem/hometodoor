...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
  ...
  <div class="box container">
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $insert; ?>" class="button  btn btn-outline"> <?php echo $button_insert; ?> </a> <a onclick="$('form').submit();" class="button  btn btn-outline"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
